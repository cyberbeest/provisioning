...
# Cyberbeest Package Manager for Chrome -- both via
# lib/cyberbeest-pkg-helper.sh setup-repo) -- writing them here first is
# harmless, so this doesn't need to run after either despite the higher
# number.
